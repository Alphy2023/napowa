        ...
        >
          ...
          <ScrollArea className="h-[calc(100vh-4rem)]">
                ...
                {filteredNavigation.map((item) => {
                      ...
                      >
                        <CollapsibleTrigger asChild>
                          <Button 
                            ...
                            className={`w-full justify-between ${isActive ? 'bg-napowa-blue/20 bg-napowa-blue hover:bg-napowa-blue/30' : ''}`}
                          >
                            <div className="flex items-center">
                  ...
                  return (
                    <Button
                      key={item.title}
                      variant={isActive ? "secondary" : "ghost"}
                      className={`w-full justify-start ${isActive ? 'bg-napowa-blue/20 bg-napowa-blue hover:bg-napowa-blue/30' : ''}`}
                      asChild
                    >
                      <Link href={item.href}>
                        <item.icon className="mr-2 h-4 w-4" />
            ...
            <div className="mt-auto border-t p-4">
              ...
              <Button variant="ghost" className="w-full justify-start bg-napowa-red hover:bg-napowa-red/80" asChild>
                <Link href="/login">
                  <LogOut className="mr-2 h-4 w-4" />
                  <span>Logout</span>
                </Link>
