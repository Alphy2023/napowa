...
import { Upload, X, Plus, ImageIcon, FileText, File } from 'lucide-react'
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Upload images to the gallery for display on the website.
        </p>
      </div>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Add details for the uploaded images.
              </CardDescription>
            </CardHeader>
